...
Object.defineProperty(exports, "__esModule", { value: true });
var value_types_1 = __webpack_require__(/*! ./value-types */ "./node_modules/quill-delta-to-html/dist/commonjs/value-types.js");
var str = __webpack_require__(/*! ./helpers/string */ "./node_modules/quill-delta-to-html/dist/commonjs/helpers/string.js");
var obj = __webpack_require__(/*! ./helpers/object */ "./node_modules/quill-delta-to-html/dist/commonjs/helpers/object.js");
...
var url = __webpack_require__(/*! ./helpers/url */ "./node_modules/quill-delta-to-html/dist/commonjs/helpers/url.js");
...
var value_types_1 = __webpack_require__(/*! ./value-types */ "./node_modules/quill-delta-to-html/dist/commonjs/value-types.js");
var obj = __webpack_require__(/*! ./helpers/object */ "./node_modules/quill-delta-to-html/dist/commonjs/helpers/object.js");
var arr = __webpack_require__(/*! ./helpers/array */ "./node_modules/quill-delta-to-html/dist/commonjs/helpers/array.js");
var OpAttributeSanitizer_1 = __webpack_require__(/*! ./OpAttributeSanitizer */ "./node_modules/quill-delta-to-html/dist/commonjs/OpAttributeSanitizer.js");
;
...
(function () {
  if ($('#editor').length) {
    editor = new quill__WEBPACK_IMPORTED_MODULE_0___default.a('#editor', options);
    $("#challengeForm").submit(function (eventObj) {
      var delta = editor.getContents();
      $("<input />").attr("type", "hidden").attr("name", "description").attr("value", JSON.stringify(delta.ops)).appendTo("#challengeForm");
      return true;
    });
  }
...
function showContent(id, delta) {
  var converter = new quill_delta_to_html__WEBPACK_IMPORTED_MODULE_1__["QuillDeltaToHtmlConverter"](delta, {});
  $('id').html(converter.convert());
}
